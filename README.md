...
However, when cloning signal of some protocol and replaying back, it doesnt get decoded with flipper and flipper saves it as BinRAW. But it will probably work on the device itself, but I dont have anything, like doorbell, to test it yet.
# External references
